...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { ferret_id: @race.ferret_id, tunnel_id: @race.tunnel_id } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { ferret_id: @race.ferret_id, tunnel_id: @race.tunnel_id } }
