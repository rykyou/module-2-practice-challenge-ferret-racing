...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { main_focus: @charity.main_focus, name: @charity.name } }
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { main_focus: @charity.main_focus, name: @charity.name } }
